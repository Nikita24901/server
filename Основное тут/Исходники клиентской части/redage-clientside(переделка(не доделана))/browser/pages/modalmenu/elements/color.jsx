...
import tinycolor from '../../../helpers/tinycolor.min.js'
...
class Color extends Component {
    ...
    componentDidMount = () => {
        ...
        function apply() {
            rage.CallClient('colors', 'apply');
        }
        function cancel() {
            rage.CallClient('colors', 'cancel');
        }
        function show(state) {
            if (state) {
        ...
        function setCurrentColor(color) {
            ...
            rage.CallClient('scolor', JSON.stringify(color.toRgb()));
        };
    ...
    render() {
        return (
            <React.Fragment>
                <div id="window" className="color-picker-panel">
                    <h2 className="panel-header top">Выберите цвет</h2>
                    <div className="panel-row">
                        <div className="swatches default-swatches"></div>
                        <button id="color-indicator" className="button preview"></button>
                    </div>
                    <div className="panel-row">
                    ...
                    <div className="panel-row">
                        ...
                        <button id="mode-toggle" className="button mode-toggle">Режим</button>
                    </div>
                </div>
            </React.Fragment>
        );
